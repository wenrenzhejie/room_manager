...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <s:form class="am-form" method="post" enctype="multipart/form-data" namespace="/" action="adminRoom_addRoom">
        ...
        <div class="am-form-group am-cf">
          <div class="you" style="margin-left: 11%;">
              <s:submit value="添加" cssClass="am-btn am-btn-success am-radius"></s:submit>
        </div>
      </s:form>
    </div>
</div>
