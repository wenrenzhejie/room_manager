...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/admin/assets/css/amazeui.datatables.min.css" />
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/admin/assets/css/app.css">
    <script src="${pageContext.servletContext.contextPath}/admin/assets/js/jquery.min.js"></script>

</head>

<body data-type="login">
    <script src="${pageContext.servletContext.contextPath}/admin/assets/js/theme.js"></script>
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" action="${pageContext.servletContext.contextPath}/admin/index.jsp">
